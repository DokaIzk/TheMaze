...
var network$1 = require('@stacks/network');
var crossfetch = require('cross-fetch');
var stacking = require('@stacks/stacking');
...
var network = require('blockstack/lib/network');
var storage = require('@stacks/storage');
...
function isTestnetAddress(address) {
  ...
  return addressInfo.version === bitcoin.networks.testnet.pubKeyHash;
}
...
function _getStacksWalletKeyInfo() {
  _getStacksWalletKeyInfo = _asyncToGenerator( /*#__PURE__*/runtime_1.mark(function _callee4(network, mnemonic) {
    var seed, master, child, ecPair, privkey, wif, addr, btcAddress, _bitcoin$payments$p2p, address, _bitcoin$payments$p2p2, _address, result;
...
function addressConvert(network, args) {
  ...
  if (addr.match(STACKS_ADDRESS_PATTERN)) {
    b58addr = c32check$1.c32ToB58(addr);
  ...
  return Promise.resolve().then(function () {
    var mainnetb58addr = network.coerceMainnetAddress(b58addr);
    var result = {
      mainnet: {
        STACKS: c32check$1.b58ToC32(mainnetb58addr),
        BTC: mainnetb58addr
      },
      testnet: undefined
    };
    ...
    if (testnetb58addr) {
      result.testnet = {
        STACKS: c32check$1.b58ToC32(testnetb58addr),
        BTC: testnetb58addr
      };
    }
...
//# sourceMappingURL=cli.cjs.development.js.map
