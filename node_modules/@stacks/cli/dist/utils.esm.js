...
import { networks, address, payments, script, crypto } from 'bitcoinjs-lib';
...
function isTestnetAddress(address$1) {
  var addressInfo = address.fromBase58Check(address$1);
  return addressInfo.version === networks.testnet.pubKeyHash;
}

export { JSONStringify, MultiSigKeySigner, NullSigner, SegwitP2SHKeySigner, answerToClarityValue, argToPrompt, canonicalPrivateKey, decodePrivateKey, generateExplorerTxPageUrl, getBackupPhrase, getIDAddress, getIDAppKeys, getNameInfoEasy, getOwnerKeyFromIDAddress, getPrivateKeyAddress, getPublicKeyFromPrivateKey, getpass, isTestnetAddress, makeProfileJWT, makePromptsFromArgList, mkdirs, nameLookup, parseClarityFunctionArgAnswers, parseMultiSigKeys, parseNullSigner, parseSegwitP2SHKeys };
